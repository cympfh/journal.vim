...
syntax match spaceAborted "\[\-\]"
syntax match spaceDatetime "\[[0-9]\{4,4}.*\]"

" For Hacking plastic-boy/vim-markdown
syn region mkdListItemLine start="^\s*\%([-*+]\|\d\+\.\)\s\+" end="$" oneline contains=@mkdNonListItem,mkdListItem,@Spell,spaceTODO,spaceDONE,spaceChecked,spaceUnChecked,spaceAborted,spaceDatetime
...
highlight default link spaceAborted Number
